...
public fun abs(arg0: I128) : I128 {
    if (sign(arg0) == 0) {
        ...
        assert!(arg0.bits > 170141183460469231731687303715884105728, 0);
...
public fun as_i32(arg0: I128) : 0x25929e7f29e0a30eb4e692952ba1b5b65a3a4d65ab5f2a32e1ba3edcb587f26d::i32::I32 {
    if (is_neg(arg0)) {
        return 0x25929e7f29e0a30eb4e692952ba1b5b65a3a4d65ab5f2a32e1ba3edcb587f26d::i32::neg_from(abs_u128(arg0) as u32)
    };
    0x25929e7f29e0a30eb4e692952ba1b5b65a3a4d65ab5f2a32e1ba3edcb587f26d::i32::from(abs_u128(arg0) as u32)
}

public fun as_i64(arg0: I128) : 0x25929e7f29e0a30eb4e692952ba1b5b65a3a4d65ab5f2a32e1ba3edcb587f26d::i64::I64 {
    if (is_neg(arg0)) {
        return 0x25929e7f29e0a30eb4e692952ba1b5b65a3a4d65ab5f2a32e1ba3edcb587f26d::i64::neg_from(abs_u128(arg0) as u64)
    };
    0x25929e7f29e0a30eb4e692952ba1b5b65a3a4d65ab5f2a32e1ba3edcb587f26d::i64::from(abs_u128(arg0) as u64)
}
...
public fun wrapping_add(arg0: I128, arg1: I128) : I128 {
    let mut v0 = arg0.bits ^ arg1.bits;
    let mut v1 = (arg0.bits & arg1.bits) << 1;
    while (v1 != 0) {
        v0 = v0 ^ v1;
        let v2 = v0 & v1;
        v1 = v2 << 1;
